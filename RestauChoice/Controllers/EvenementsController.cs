...
namespace RestauChoice.Controllers
{
    public class EvenementsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EvenementId,Nom,Description")] Evenement evenement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EvenementId,Nom,Description")] Evenement evenement)
        {
            if (ModelState.IsValid)
            {
